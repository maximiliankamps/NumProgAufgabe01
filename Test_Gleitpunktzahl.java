...
public class Test_Gleitpunktzahl {
	...
	public static void main(String[] argv) {
		...
		/*
		 * int perfectNumber = 1; FastMath.setMagic(1);
		 * 
		 * double abs = Math.abs(0.3001501128 - FastMath.invSqrt(new
		 * Gleitpunktzahl(11.1)).toDouble()); for (double i = 1; i < 100000; i = i +
		 * 1.0) {
		 * 
		 * System.out.println(abs); FastMath.setMagic((int) i); if (abs >
		 * Math.abs(0.3001501128 - FastMath.invSqrt(x).toDouble())) { abs =
		 * Math.abs(0.3001501128 - FastMath.invSqrt(x).toDouble()); perfectNumber =
		 * (int) i; System.out.println(abs); }
		 * 
		 * System.out.println(Math.abs(0.3001501128 - FastMath.invSqrt(new
		 * Gleitpunktzahl(i)).toDouble())); } System.out.println("ABS is " + abs);
